    ...
    try {
        ...
        const metadata = {
            ...
            description: marked
                ...
                .join(" ")
                .trim(),
            image: hasCover ? `${baseUrl}/events/${group.image}` : null,
...
router.get("/:eventID", async (req, res) => {
    try {
        ...
        const privateCount = attendees.reduce(
            (sum, a) =>
                a.visibility === "private" ? sum + (a.number || 1) : sum,
            0,
        );
        ...
        const metadata = {
            ...
            description: marked
                ...
                .join(" ")
                .trim(),
            image: event.image ? `${baseUrl}/events/${event.image}` : null,
        ...
        if (acceptsActivityPub(req)) {
            ...
            return res.render("event", {
                ...
                eventHasBegun,
                eventWillBeDeleted:
                    res.locals.config.general.delete_after_days > 0,
